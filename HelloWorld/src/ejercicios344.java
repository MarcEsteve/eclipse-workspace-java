public class ejercicios344 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*Ejercicio: escribe un programa que almacene tres ángulos de un triángulo en variables de
		tipo entero (angulo1, angulo2 y angulo3). Crea un condicional que compruebe si esos
		tres ángulos juntos pueden formar un triángulo (los ángulos de un triángulo suman
		siempre 180 grados).
		*/
		...
		evalúe si el entero es par o impar utilizando el operador %.*/
		int a3= 13;
		if (a3%2==0) {
		...
		/*Ejercicio pag 348: escribe un programa que dado tres números imprima por pantalla cuál es el
		mayor.*/
