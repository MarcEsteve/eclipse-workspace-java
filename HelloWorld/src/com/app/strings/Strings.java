...
public class Strings {
	...
	public static void main(String[] args) {
		...
		//de 16 caracteres. Se genera un excepción de tipo 
		...
		// 15, encuentra la última "o"
		System.out.println(texto.indexOf('o', 4));
		// -1, no encuentra a partir del índice 6 "es"
		...
		// true
		System.out.println(texto4.equalsIgnoreCase("adiós"));
		// true
		System.out.println(texto1.contains("ol"));
		// false
		System.out.println(texto1.equals("al"));
		String textoSaludo = "Hola, cómo estás";
		// cómo estás
