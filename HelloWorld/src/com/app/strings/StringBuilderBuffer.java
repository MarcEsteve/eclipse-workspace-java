...
public class StringBuilderBuffer {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//capacidad de 16 elementos vacíos
		StringBuilder strb1 = new StringBuilder();
		//variable de tipo StringBuilder con la 
		//capacidad del String pasado por parámetro (4
		//caracteres), más 16 elementos vacíos 
		//adicionales
		...
		//MÉTODO append(String str)
		// agrega el carácter a al final del 
		//StringBuilder
		strb.append("a");
		// holaa
		System.out.println(strb);
		//MÉTODO insert(int offset, String str)
		...
		//MÉTODO setCharAt(int index, char ch)
		// reemplaza el carácter del índice 2, la l, 
		//del StringBuilder con el carácter c
